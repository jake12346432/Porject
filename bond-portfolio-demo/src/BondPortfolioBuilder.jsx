  ...
  return (
    <ResponsiveContainer width="100%" height={Math.max(140, data.length * 30)}>
      <BarChart data={data} layout="vertical" margin={{ top: 4, right: 20, bottom: 4, left: 4 }}>
        ...
        <Tooltip formatter={(v) => v.toFixed(1) + "%"} contentStyle={{ background: t.surface2, border: `1px solid ${t.border}`, borderRadius: 8, fontSize: 12, color: t.text }} />
...
/* ============================== MAIN ============================== */
export default function BondPortfolioBuilder() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: t.bg, color: t.text, transition: "background 0.2s, color 0.2s" }}>
      ...
      <div style={{
        ...
        <span style={{ fontSize: 13, fontWeight: 600, color: t.textSecondary }}>Fixed Income Screen</span>
